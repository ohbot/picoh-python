...
def sel():
    ...
    if stage == 0:
        ...
        label.config(text = "Move the slider to the right until the top lip drops onto the bottom lip. Don't go further than necessary!")
...
label = Tk.Label(root, text = 'Move the slider to the left until the bottom lip just touches the top lip')
label.pack()
