...
setLabel = Tk.Label(frameThree, text="Set", font=customFont, width=5)
setLabel.grid(column=0, row=0, sticky='w')

variableLabel = Tk.Label(frameThree, text="Variable", font=customFont, width=10)
variableLabel.grid(column=1, row=0, sticky='w')

phraseLabel = Tk.Label(frameThree, text="Phrase (Leave blank to delete)", font=customFont)
